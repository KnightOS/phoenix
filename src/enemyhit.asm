...
build_table_loop:
    ...
    kcall(which_group)         ; Compute group number in A
...
smc_test_2:
    ...
    add a, a
    inc a
    add a, l \ ld l, a \ jr nc, $+3 \ inc h        ; HL = new entry in group     
...
loop_process_bullets:
    ...
    kcall(which_group)         ; A = group number

    kld(de, test_coords)      ; Copy bullet data to test coords
    ldi
    ldi
    ldi
    ldi
